(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=o(s);fetch(s.href,r)}})();const Xe="/Portfolio_Valerio/",c=e=>`${Xe}${e.replace(/^\/+/,"")}`,F=window.matchMedia("(max-width: 640px)"),de=window.matchMedia("(prefers-reduced-motion: reduce)"),M=document.getElementById("wiiIntro");let V=!1;const S=document.getElementById("grid");document.getElementById("board");const ye=document.getElementById("time"),Ie=document.getElementById("date"),q=document.getElementById("btnLeft"),Q=document.getElementById("btnRight"),g=document.getElementById("wiiOverlay"),Ae=document.getElementById("overlayBack"),z=document.getElementById("overlayTitle"),m=document.getElementById("overlayBody"),y=document.getElementById("wiiPointer"),C=document.getElementById("imgViewer"),K=document.getElementById("imgViewerSrc"),L=document.getElementById("videoViewer"),A=document.getElementById("videoViewerSrc");let pe=[];function Ye(e,t,o){return Math.max(t,Math.min(o,e))}const Je=[[{icon:"👋",t:"Chi sono",s:"Bio + competenze",href:"#about",previews:[c("img/BIO/BIO_1.jpg"),c("img/BIO/BIO_2.jpg"),c("img/BIO/BIO_3.jpg")]},{icon:"🎓",t:"Esperienze",s:"Formazione / studi",href:"#exp"},{icon:"✉️",t:"Contatti",s:"Mail e social",href:"#contact"},{icon:"🧩",t:"Progetti",s:"Case study e lavori",href:"#projects",previews:[c("img/PROGETTI/PROG_1.jpg"),c("img/PROGETTI/PROG_2.jpg"),c("img/PROGETTI/PROG_3.jpg")]},{icon:"📱",t:"Social",s:"I miei profili",href:"#social"},{icon:"🎬",t:"Video",s:"Social e progetti",href:"#videos",previewAnim:"wiiPreviewFadeTight",previews:[c("img/CHANNELS/VIDEO/VIDEO PROMO_3-frame.jpg"),c("img/CHANNELS/VIDEO/meschia-cover.jpg"),c("img/CHANNELS/VIDEO/PROGETTI PERSONALI_2-frame.jpg"),c("img/CHANNELS/VIDEO/REQUIEM LOCANDINA.jpg")]},{icon:"🛠️",t:"Skills",s:"Cosa so fare",href:"#tools"},{icon:"🤖",t:"AI",s:"Workflow",href:"#ai",previewVideo:{src:c("img/CHANNELS/ai.mp4"),poster:c("img/CHANNELS/ai-frame.jpg")}},{icon:"📌",t:"Servizi",s:"Cosa offro",href:"#services",previewVideo:{src:c("img/CHANNELS/servizi.mp4"),poster:c("img/CHANNELS/servizi-frame.jpg")}}],[{icon:"📷",t:"Galleria",s:"Foto e frame",href:"#gallery"},{icon:"🗂️",t:"Archivio",s:"Lavori passati",href:"#archive"},{icon:"📝",t:"Blog",s:"Note e making-of",href:"#blog"},{icon:"📍",t:"Dove sono",s:"Roma / contatti",href:"#where"}]];let H=0;const Ze=420,et=320,tt=900;function it(){return Je[0]}function ot(){if(!S)return;const e=it();S.innerHTML=e.map(t=>{const o=t.previewVideo?.src,i=t.previewVideo?.poster,s=Array.isArray(t.previews)?t.previews:[],r=i?` poster="${i}"`:"",a=i?` style="--preview-poster:url('${i}')"`:"",l=s.length>1?` style="--preview-step:3s; --preview-duration:${s.length*3}s${t.previewAnim?`; --preview-anim:${t.previewAnim}`:""}"`:"",p=o?`
    ...
    `}};function pt(e){const o=_["#videos"]?.sections||[];return o.length?o.find(i=>i.id===e)||o[0]:null}function Ne(){if(!m||!z||!g)return;const e=_["#videos"],t=e?.sections||[];if(!t.length)return;d.videoSectionId=null,g.classList.remove("is-video-detail"),z.textContent=e.title;const o=t.map(i=>{const s=i.hubThumb||i.hero?.src,r=s?` style="--thumb:url('${s}')"`:"";return`
      ...
      `}).join("");m.innerHTML=`<div class="video-hub">${o}</div>`,m.scrollTop=0}function mt(e){if(!m||!z||!g)return;const t=pt(e);if(!t)return;d.videoSectionId=t.id,z.textContent=t.title,g.classList.add("is-video-detail");const o=t.hero?.src?` style="--hero:url('${t.hero.src}')"`:"",i=t.hero?.alt?` role="img" aria-label="${t.hero.alt}"`:"",s=(t.videos||[]).map(r=>{const a=!!r.src,l=!!r.static,p=r.poster||t.hero?.src||"",u=p?` style="--thumb:url('${p}')"`:"";return`
