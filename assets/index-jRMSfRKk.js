(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function o(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(s){if(s.ep)return;s.ep=!0;const r=o(s);fetch(s.href,r)}})();const nt="/Portfolio_Valerio/",c=e=>`${nt}${e.replace(/^\/+/,"")}`,K=window.matchMedia("(max-width: 640px)"),ue=window.matchMedia("(prefers-reduced-motion: reduce)"),N=document.getElementById("wiiIntro");let H=!1;const M=document.getElementById("grid");document.getElementById("board");const Ve=document.getElementById("time"),Pe=document.getElementById("date"),Q=document.getElementById("btnLeft"),te=document.getElementById("btnRight"),y=document.getElementById("wiiOverlay"),Re=document.getElementById("overlayBack"),z=document.getElementById("overlayTitle"),b=document.getElementById("overlayBody"),S=document.getElementById("wiiPointer"),R=document.getElementById("imgViewer"),ie=document.getElementById("imgViewerSrc"),O=document.getElementById("videoViewer"),C=document.getElementById("videoViewerSrc");let ge=[];function fe(e,t,o){return Math.max(t,Math.min(o,e))}const st=[[{icon:"👋",t:"Chi sono",s:"Bio + competenze",href:"#about",previews:[c("img/BIO/BIO_1.jpg"),c("img/BIO/BIO_2.jpg"),c("img/BIO/BIO_3.jpg")]},{icon:"🎓",t:"Esperienze",s:"Formazione / studi",href:"#exp"},{icon:"📬",t:"Contatti",s:"Mail e social",href:"#contact"},{icon:"🧩",t:"Progetti",s:"Case study e lavori",href:"#projects",previews:[c("img/PROGETTI/PROG_1.jpg"),c("img/PROGETTI/PROG_2.jpg"),c("img/PROGETTI/PROG_3.jpg")]},{icon:"📱",t:"Social",s:"I miei profili",href:"#social"},{icon:"🎬",t:"Video",s:"Social e progetti",href:"#videos",previewAnim:"wiiPreviewFadeTight",previews:[c("img/CHANNELS/VIDEO/VIDEO PROMO_3-frame.jpg"),c("img/CHANNELS/VIDEO/meschia-cover.jpg"),c("img/CHANNELS/VIDEO/PROGETTI PERSONALI_2-frame.jpg"),c("img/CHANNELS/VIDEO/REQUIEM LOCANDINA.jpg")]},{icon:"🛠️",t:"Skills",s:"Cosa so fare",href:"#tools"},{icon:"🤖",t:"AI",s:"Workflow",href:"#ai",previewVideo:{src:c("img/CHANNELS/ai.mp4"),poster:c("img/CHANNELS/ai-frame.jpg")}},{icon:"📌",t:"Servizi",s:"Cosa offro",href:"#services",previewVideo:{src:c("img/CHANNELS/servizi.mp4"),poster:c("img/CHANNELS/servizi-frame.jpg")}}],[{icon:"📷",t:"Galleria",s:"Foto e frame",href:"#gallery"},{icon:"🗂️",t:"Archivio",s:"Lavori passati",href:"#archive"},{icon:"📝",t:"Blog",s:"Note e making-of",href:"#blog"},{icon:"📍",t:"Dove sono",s:"Roma / contatti",href:"#where"}]];let j=0;const rt=420,ct=320,lt=900;function dt(){return st[0]}function mt(){if(!M)return;const e=dt();M.innerHTML=e.map(t=>{const o=t.previewVideo?.src,a=t.previewVideo?.poster,s=Array.isArray(t.previews)?t.previews:[],n=!o&&!s.length?"wii-tile wii-tile--iconPreview":"wii-tile",l=a?` poster="${a}"`:"",p=a?` style="--preview-poster:url('${a}')"`:"",m=s.length>1?` style="--preview-step:3s; --preview-duration:${s.length*3}s${t.previewAnim?`; --preview-anim:${t.previewAnim}`:""}"`:"",u=o?`
        ...
        `:s.length?`
          <div class="wii-preview ${s.length===1?"wii-preview--single":""}"${m} aria-hidden="true">
            ${s.map(A=>`<img src="${A}" alt="" loading="lazy" decoding="async">`).join("")}
          </div>
        `:`
      ...
      `}).join(""),pt(),ut(),$e(),k()}function pt(){if(!M)return;Array.from(M.querySelectorAll(".wii-preview:not(.wii-preview--single)")).forEach((t,o)=>{const a=window.getComputedStyle(t),s=parseFloat(a.getPropertyValue("--preview-duration"))||12,r=parseFloat(a.getPropertyValue("--preview-step"))||4,n=(o+1)*r*1.618%s;t.style.setProperty("--preview-phase",`-${n.toFixed(2)}s`)})}function $e(){if(!M)return;Array.from(M.querySelectorAll(".wii-preview--video")).forEach(t=>{const o=t.closest(".wii-tile");if(!o)return;const a=o.getBoundingClientRect();if(!a.height)return;const s=a.width/a.height,r=Math.max(1,Math.min(s,16/9));t.style.setProperty("--video-zoom",r.toFixed(3))})}function ut(){if(!M)return;const e=Array.from(M.querySelectorAll(".wii-preview--video"));ge=[],e.forEach(t=>{const o=t.closest(".wii-tile");if(!o)return;const a=t.querySelector(".preview-video");if(!a)return;ge.push({preview:t,video:a}),a.muted=!0,a.loop=!0,a.setAttribute("playsinline","");const s=()=>{if(t.classList.add("is-ready"),a.paused)try{a.currentTime=0}catch{}};a.addEventListener("loadeddata",s,{once:!0});const r=()=>{t.classList.add("is-hover"),a.currentTime=0,a.play().catch(()=>{})},n=()=>{a.pause(),a.currentTime=0,t.classList.remove("is-hover")};o.addEventListener("mouseenter",r),o.addEventListener("mouseleave",n),o.addEventListener("pointerenter",r),o.addEventListener("pointerleave",n),o.addEventListener("focusin",r),o.addEventListener("focusout",n)})}function k(){const e=K.matches&&!ue.matches;ge.forEach(({preview:t,video:o})=>{if(e)t.classList.add("is-auto"),o.play().catch(()=>{});else{t.classList.remove("is-auto"),o.pause();try{o.currentTime=0}catch{}}})}function _e(){if(!Ve||!Pe)return;const e=new Date,t=String(e.getHours()).padStart(2,"0"),o=String(e.getMinutes()).padStart(2,"0");Ve.textContent=`${t}:${o}`;const a=["Dom","Lun","Mar","Mer","Gio","Ven","Sab"],s=["Gen","Feb","Mar","Apr","Mag","Giu","Lug","Ago","Set","Ott","Nov","Dic"],r=e.getDate(),n=a[e.getDay()],l=s[e.getMonth()];Pe.textContent=`${n} ${r} ${l}`}let P=null,L=!0,ze=!1,Ne=0;function B(){return L?(P||(P=new(window.AudioContext||window.webkitAudioContext)),P.state==="suspended"&&P.resume().catch(()=>{}),P):null}function _(){const e=B();if(e){e.state==="suspended"&&e.resume().catch(()=>{});try{const t=e.createBuffer(1,1,e.sampleRate),o=e.createBufferSource();o.buffer=t,o.connect(e.destination),o.start(0)}catch{}}}function q(){ze||(ze=!0,_())}function qe({type:e="sine",freq:t=700,duration:o=.05,gain:a=.04,attack:s=.002,release:r=.035}={}){const n=B();if(!n)return;const l=n.currentTime,p=n.createOscillator(),m=n.createGain();p.type=e,p.frequency.setValueAtTime(t,l),m.gain.setValueAtTime(0,l),m.gain.linearRampToValueAtTime(a,l+s),m.gain.exponentialRampToValueAtTime(1e-4,l+s+r),p.connect(m),m.connect(n.destination),p.start(l),p.stop(l+o+r+.02)}function gt(){const e=performance.now();e-Ne<120||(Ne=e,qe({type:"sine",freq:880,duration:.03,gain:.026,attack:.002,release:.03}))}function x(){qe({type:"triangle",freq:520,duration:.03,gain:.05,attack:.001,release:.02})}let T=null,G=!1;function F(){const e=B();if(!e||T)return;const t=e.createGain();t.gain.value=0,t.connect(e.destination);const o=e.createGain();o.gain.value=.82;const a=e.createBiquadFilter();a.type="lowpass",a.frequency.value=3100,a.Q.value=.55;const s=e.createDelay(.8);s.delayTime.value=.36;const r=e.createGain();r.gain.value=.18;const n=e.createGain();n.gain.value=.34,o.connect(a),a.connect(t),a.connect(s),s.connect(r),r.connect(s),s.connect(n),n.connect(t);const l=e.currentTime,p=e.createOscillator();p.type="sine",p.frequency.value=261.63;const m=e.createGain();m.gain.value=1e-4;const u=e.createOscillator();u.type="sine",u.frequency.value=.045;const A=e.createGain();A.gain.value=.012,p.connect(m),u.connect(A),A.connect(m.gain),m.connect(o),p.start(l),u.start(l),m.gain.setTargetAtTime(.01,l+.2,1.8);function D(E,d,I=.035,g=.34){const f=e.createOscillator(),h=e.createGain(),w=e.createBiquadFilter();f.type="sine",f.frequency.setValueAtTime(E,d),f.frequency.exponentialRampToValueAtTime(E*1.004,d+g),w.type="highpass",w.frequency.setValueAtTime(420,d),h.gain.setValueAtTime(1e-4,d),h.gain.exponentialRampToValueAtTime(I,d+.018),h.gain.exponentialRampToValueAtTime(1e-4,d+g),f.connect(w),w.connect(h),h.connect(o),f.start(d),f.stop(d+g+.04)}function Le(E,d,I=.018){E.forEach((g,f)=>{const h=e.createOscillator(),w=e.createGain(),V=e.createBiquadFilter();h.type=f===1?"triangle":"sine",h.frequency.setValueAtTime(g,d),h.detune.setValueAtTime((f-1)*4,d),V.type="lowpass",V.frequency.setValueAtTime(1350,d),w.gain.setValueAtTime(1e-4,d),w.gain.exponentialRampToValueAtTime(I,d+.12+f*.03),w.gain.exponentialRampToValueAtTime(1e-4,d+1.7),h.connect(V),V.connect(w),w.connect(o),h.start(d),h.stop(d+1.9)})}function Ce(E,d,I=.016){const g=e.createOscillator(),f=e.createGain(),h=e.createBiquadFilter();g.type="triangle",g.frequency.setValueAtTime(E*.72,d),g.frequency.exponentialRampToValueAtTime(E,d+.16),h.type="bandpass",h.frequency.setValueAtTime(E*2.2,d),h.Q.setValueAtTime(1.2,d),f.gain.setValueAtTime(1e-4,d),f.gain.exponentialRampToValueAtTime(I,d+.025),f.gain.exponentialRampToValueAtTime(1e-4,d+.3),g.connect(h),h.connect(f),f.connect(o),g.start(d),g.stop(d+.34)}function Oe(E,d,I=.012){const g=e.createOscillator(),f=e.createGain(),h=e.createBiquadFilter();g.type="sine",g.frequency.setValueAtTime(E,d),g.frequency.exponentialRampToValueAtTime(E*.995,d+.42),h.type="lowpass",h.frequency.setValueAtTime(360,d),f.gain.setValueAtTime(1e-4,d),f.gain.exponentialRampToValueAtTime(I,d+.04),f.gain.exponentialRampToValueAtTime(1e-4,d+.48),g.connect(h),h.connect(f),f.connect(o),g.start(d),g.stop(d+.52)}function it(E,d=.006){const I=Math.max(1,Math.floor(e.sampleRate*.08)),g=e.createBuffer(1,I,e.sampleRate),f=g.getChannelData(0);for(let X=0;X<I;X+=1){const de=1-X/I;f[X]=(Math.random()*2-1)*de*de*de}const h=e.createBufferSource(),w=e.createGain(),V=e.createBiquadFilter();V.type="highpass",V.frequency.value=5200,w.gain.setValueAtTime(d,E),w.gain.exponentialRampToValueAtTime(1e-4,E+.09),h.buffer=g,h.connect(V),V.connect(w),w.connect(o),h.start(E)}const W=[{chord:[261.63,329.63,392],bass:130.81,motif:[392,523.25,493.88,329.63]},{chord:[293.66,369.99,440],bass:146.83,motif:[440,587.33,554.37,369.99]},{chord:[220,329.63,392],bass:110,motif:[329.63,440,392,261.63]},{chord:[246.94,293.66,392],bass:123.47,motif:[392,493.88,587.33,493.88]}],ot=[{beat:0,kind:"chord"},{beat:1,kind:"lead",note:0},{beat:2.5,kind:"bubble",note:1},{beat:4,kind:"lead",note:2},{beat:5.5,kind:"hush"},{beat:7,kind:"lead",note:3},{beat:8,kind:"chord"},{beat:9.5,kind:"bubble",note:2},{beat:11,kind:"lead",note:1},{beat:13.5,kind:"hush"}],ce=380,at=16;let le=0;function Me(){if(!L||!P||!T)return;const E=P.currentTime+.03,d=W[le%W.length],I=W[(le+1)%W.length];if(p.frequency.setTargetAtTime(d.chord[0],E,.8),Oe(d.bass,E+.02,.01),ot.forEach(g=>{const f=E+g.beat*(ce/1e3);if(g.kind==="chord"){Le(g.beat>=8?I.chord:d.chord,f,.014),Oe(g.beat>=8?I.bass:d.bass,f+.04,.009);return}if(g.kind==="lead"){const h=d.motif[g.note%d.motif.length];D(h,f,g.beat===1?.038:.03,.42),Math.random()<.35&&D(h*1.5,f+.18,.014,.28);return}if(g.kind==="bubble"){Ce(d.motif[g.note%d.motif.length],f,.014);return}it(f,.005)}),Math.random()<.55){const g=d.motif[Math.floor(Math.random()*d.motif.length)];Ce(g*2,E+(14.5+Math.random())*(ce/1e3),.01)}le+=1,T.timerId=window.setTimeout(Me,at*ce)}T={musicGain:t,toneBus:o,toneFilter:a,delay:s,fb:r,delayMix:n,air:p,airGain:m,airLfo:u,timerId:null},Me(),t.gain.setTargetAtTime(.36,e.currentTime,.9)}function Fe(){if(!P||!T)return;const e=P.currentTime;T.timerId&&clearTimeout(T.timerId),T.musicGain.gain.setTargetAtTime(1e-4,e,.25),setTimeout(()=>{try{T.air?.stop()}catch{}try{T.airLfo?.stop()}catch{}T=null},400)}Q&&(Q.textContent="🔊",Q.addEventListener("click",()=>{H&&(performance.now()<j||(L=!L,Q.textContent=L?"🔊":"🔇",L?(q(),_(),F(),x()):Fe()))}));te&&(te.textContent="🎮");["pointerdown","touchstart","mousedown"].forEach(e=>{window.addEventListener(e,()=>{L&&(q(),F())},{once:!0,passive:!0})});const v={href:null,projectIndex:0,slideIndex:0,dom:null,videoSectionId:null};let Y=null;const ke="https://www.linkedin.com/in/valerio-serani-682a48215/",ft="https://www.instagram.com/velvet_172/",vt="https://www.tiktok.com/@heyits172",ht="https://vimeo.com/user95787021",bt="https://www.behance.net/velvet172",He="valerioserani@gmail.com",Be="+39 3469697747",U={"#projects":{title:"Progetti",projects:[{id:"bestof",slides:[{src:c("img/PROGETTI/PROG_1.jpg"),client:"Sunsilk",title:"Materiali promozionali",what:"Creativity + layout",moreHtml:`
    ...
    `},"#contact":{title:"Contatti",html:`
      <div class="wii-card">
        ...
        <p><strong>Telefono</strong>: <a href="tel:${Be.replace(/\s+/g,"")}">${Be}</a></p>
  ...
  `,b.scrollTop=0}function wt(){if(!b)return;const e=U["#projects"],o=(e.projects[v.projectIndex]||e.projects[0])?.slides||[];if(!o.length)return;v.slideIndex=fe(v.slideIndex,0,o.length-1),b.innerHTML=`
...
`;const a={frame:b.querySelector("[data-ch-frame]"),imgs:Array.from(b.querySelectorAll(".chMedia")),more:b.querySelector(".chMore"),moreContent:b.querySelector(".chMoreContent"),capClient:b.querySelector('[data-cap="client"]'),capTitle:b.querySelector('[data-cap="title"]'),capWhat:b.querySelector('[data-cap="what"]')};v.dom=a,ye(o,v.slideIndex);const s=b.querySelector('[data-ch="more"]');s&&(s.textContent="Scopri di più")}function ye(e,t){const o=e[t],a=v.dom;!o||!a||(a.capClient&&(a.capClient.textContent=o.client||""),a.capTitle&&(a.capTitle.textContent=o.title||""),a.capWhat&&(a.capWhat.textContent=o.what||""),a.frame&&a.frame.style.setProperty("--ch-bg",`url("${o.src}")`),a.moreContent&&(a.moreContent.innerHTML=o.moreHtml||""))}function me(){return!!v.dom?.frame?.classList.contains("is-more")}function It(e){const t=v.dom;!t?.frame||!t?.more||(t.frame.classList.add("is-more"),t.more.classList.add("is-open"),t.more.setAttribute("aria-hidden","false"),ye(e,v.slideIndex))}function J(){const e=v.dom;!e?.frame||!e?.more||(e.frame.classList.remove("is-more"),e.more.classList.remove("is-open"),e.more.setAttribute("aria-hidden","true"))}function At(){We();const e=b?.querySelector(".bioCarousel"),t=b?.querySelector(".wii-card"),o=e?Array.from(e.querySelectorAll(".bioMedia")):[];if(!e||!o.length)return;t&&t.classList.add("bio-no-blur");let a=0;const s=()=>{o.forEach((n,l)=>n.classList.toggle("is-on",l===a));const r=o[a]?.getAttribute("src");r&&e.style.setProperty("--bio-bg",`url("${r}")`)};s(),Y=window.setInterval(()=>{a=(a+1)%o.length,s()},3e3),t&&t.classList.add("bio-no-blur")}function We(){Y&&(clearInterval(Y),Y=null)}function Xe(e){if(!y||!z||!b)return;v.href=e,y.classList.toggle("is-game",e==="#minigame"),y.classList.toggle("is-carousel",e==="#projects"),y.classList.toggle("is-about",e==="#about"),y.classList.toggle("is-exp",e==="#exp"),y.classList.toggle("is-videos",e==="#videos");const t=U[e]||{title:"Canale",html:'<div class="wii-card"><h3>Coming soon</h3><p>Contenuto in arrivo.</p></div>'};z.textContent=t.title,e==="#projects"&&t.projects?(v.projectIndex=0,v.slideIndex=0,v.dom=null,wt()):e==="#about"?(b.innerHTML=t.html||"",At()):e==="#videos"&&t.sections?Ue():b.innerHTML=t.html||"",y.classList.add("is-open"),y.setAttribute("aria-hidden","false"),e==="#minigame"?requestAnimationFrame(()=>{Ot()&&$()}):re(!1),x()}function se(){y&&(J(),we(),re(!1),We(),v.videoSectionId=null,y.classList.remove("is-open","is-game","is-carousel","is-videos","is-video-detail"),y.setAttribute("aria-hidden","true"),x())}function Tt(){if(v.href==="#videos"&&y?.classList.contains("is-video-detail")){Ue();return}se()}Re&&Re.addEventListener("click",Tt);function xe(e){!R||!ie||!e||(document.body?.classList.add("is-img-viewer-open"),ie.src=e,R.classList.add("is-open"),R.setAttribute("aria-hidden","false"))}function Qe(){!R||!ie||(document.body?.classList.remove("is-img-viewer-open"),R.classList.remove("is-open"),R.setAttribute("aria-hidden","true"),ie.src="")}R&&R.addEventListener("click",Qe);function St(e,t){if(!(!O||!C||!e)){document.body?.classList.add("is-video-viewer-open"),G=!!(L&&T),G&&Fe(),C.src=e,t?C.setAttribute("poster",t):C.removeAttribute("poster"),O.classList.add("is-open"),O.setAttribute("aria-hidden","false");try{C.currentTime=0}catch{}C.play().catch(()=>{})}}function we(){!O||!C||(document.body?.classList.remove("is-video-viewer-open"),O.classList.remove("is-open"),O.setAttribute("aria-hidden","true"),C.pause(),C.removeAttribute("src"),C.load(),G&&L?(G=!1,q(),_(),F()):G=!1)}O&&O.addEventListener("click",e=>{e.target===O&&we()});y&&y.addEventListener("click",e=>{e.target===y&&se()});document.addEventListener("keydown",e=>{if(e.key==="Escape"&&O?.classList.contains("is-open")){we();return}if(e.key==="Escape"&&R?.classList.contains("is-open")){Qe();return}e.key==="Escape"&&y?.classList.contains("is-open")&&se()});document.addEventListener("click",e=>{if(!H)return;if(performance.now()<j){e.preventDefault(),e.stopPropagation();return}const t=e.target?.closest?.(".wii-tile");if(!t)return;const o=t.getAttribute("data-href")||t.getAttribute("href");o&&o.startsWith("#")&&(e.preventDefault(),Xe(o))});te&&te.addEventListener("click",e=>{H&&(performance.now()<j||(e.preventDefault(),Xe("#minigame")))});b?.addEventListener("click",e=>{if(v.href==="#videos"){const l=e.target?.closest?.("[data-video-section]");if(l){const u=l.getAttribute("data-video-section");u&&yt(u);return}const p=e.target?.closest?.("[data-image-open]");if(p){const u=p.getAttribute("data-image-src");u&&xe(u);return}const m=e.target?.closest?.("[data-video-open]");if(m){const u=m.getAttribute("data-video-src");if(u){const A=m.getAttribute("data-video-poster")||"";St(u,A)}return}}if(v.href==="#projects"&&e.target?.closest?.("[data-ch-frame]")){const m=v.dom?.imgs?.find(u=>u.classList.contains("is-on"))?.getAttribute("src");if(m){e.preventDefault(),e.stopPropagation(),xe(m);return}}const t=e.target?.closest?.("[data-ch]"),o=t?.getAttribute("data-ch");if(e.target?.closest?.("[data-ch-frame]")&&me()&&!t){J();const l=b.querySelector('[data-ch="more"]');l&&(l.textContent="Scopri di più");return}if(!o||v.href!=="#projects")return;const s=U["#projects"],n=(s.projects[v.projectIndex]||s.projects[0])?.slides||[];if(n.length){if(o==="more"){me()?(J(),t.textContent="Scopri di più"):(It(n),t.textContent="Chiudi");return}if(o==="prev"||o==="next"){if(me()){J();const l=b.querySelector('[data-ch="more"]');l&&(l.textContent="Scopri di più")}o==="prev"?v.slideIndex=(v.slideIndex-1+n.length)%n.length:v.slideIndex=(v.slideIndex+1)%n.length,v.dom?.imgs?.forEach((l,p)=>l.classList.toggle("is-on",p===v.slideIndex)),ye(n,v.slideIndex);return}}});let ve=0,he=0,Z=0,ee=0,be=!1,De=!1,oe="mouse",ae=null;function Lt(){S&&(be||(be=!0,S.style.opacity="1"))}function Ke(){S&&(be=!1,S.style.opacity="0")}function Ye(){Z+=(ve-Z)*.42,ee+=(he-ee)*.42;const e=-10,t=-4;S&&(S.style.transform=`translate3d(${Z+e}px, ${ee+t}px, 0)`),requestAnimationFrame(Ye)}requestAnimationFrame(Ye);window.addEventListener("pointermove",e=>{if(oe=e.pointerType||"mouse",oe!=="mouse"){Ke();return}ve=e.clientX,he=e.clientY,De||(Z=ve,ee=he,De=!0),Lt()});window.addEventListener("mouseleave",()=>Ke());const Je=".wii-tile, .wii-pill";function Ze(e){S&&S.classList.toggle("is-hover",e)}document.addEventListener("pointerover",e=>{if(oe!=="mouse")return;const t=e.target?.closest?.(Je);t&&t!==ae&&(ae=t,Ze(!0),gt())});document.addEventListener("pointerout",e=>{const t=e.target?.closest?.(Je);if(t&&t===ae){const o=e.relatedTarget;if(o&&t.contains(o))return;ae=null,Ze(!1)}});document.addEventListener("pointerdown",()=>{L&&(q(),_(),F()),!(!S||oe!=="mouse")&&(S.classList.add("is-down"),x())});document.addEventListener("pointerup",()=>{S&&S.classList.remove("is-down")});let i={gameIndex:0,gameMode:"bubble",running:!1,score:0,timeLeft:30,lastTs:0,spawnAcc:0,bubbles:[],stars:[],paddleX:.5,rafId:null,timerId:null,canvas:null,ctx:null,scoreEl:null,timeEl:null,titleEl:null,helpEl:null,overEl:null,overScoreEl:null,overRestartBtn:null,overCloseBtn:null};const ne=[{mode:"bubble",title:"Bubble Pop",help:"Clicca le bolle prima che scadano i 30 secondi."},{mode:"star",title:"Star Catch",help:"Muovi il puntatore per prendere le stelle. Evita quelle rosse."}];function Ie(){i.overEl&&(i.overEl.classList.remove("is-show"),i.overEl.setAttribute("aria-hidden","true"))}function Ct(){i.overEl&&(i.overScoreEl&&(i.overScoreEl.textContent=String(i.score)),i.overEl.classList.add("is-show"),i.overEl.setAttribute("aria-hidden","false"))}function Ot(){i.canvas=document.getElementById("mgCanvas"),i.scoreEl=document.getElementById("mgScore"),i.timeEl=document.getElementById("mgTime"),i.titleEl=document.getElementById("mgGameTitle"),i.helpEl=document.getElementById("mgHelp"),i.overEl=document.getElementById("mgOver"),i.overScoreEl=document.getElementById("mgOverScore"),i.overRestartBtn=document.getElementById("mgOverRestart"),i.overCloseBtn=document.getElementById("mgOverClose");const e=document.getElementById("mgStart"),t=document.getElementById("mgReset"),o=document.getElementById("mgPrevGame"),a=document.getElementById("mgNextGame");return i.canvas?(i.ctx=i.canvas.getContext("2d"),Ie(),i.overRestartBtn&&(i.overRestartBtn.onclick=()=>{$(),je()}),i.overCloseBtn&&(i.overCloseBtn.onclick=()=>se()),i.canvas.onpointermove=s=>{if(i.gameMode!=="star")return;const r=i.canvas.getBoundingClientRect(),n=(s.clientX-r.left)/r.width*i.canvas.width;i.paddleX=fe(n/i.canvas.width,.06,.94)},i.canvas.onpointerdown=s=>{if(!i.running)return;const r=i.canvas.getBoundingClientRect(),n=(s.clientX-r.left)/r.width*i.canvas.width,l=(s.clientY-r.top)/r.height*i.canvas.height;if(i.gameMode==="star"){i.paddleX=fe(n/i.canvas.width,.06,.94);return}for(let p=i.bubbles.length-1;p>=0;p--){const m=i.bubbles[p],u=n-m.x,A=l-m.y;if(u*u+A*A<=m.r*m.r){i.bubbles.splice(p,1),i.score+=1,i.scoreEl&&(i.scoreEl.textContent=String(i.score)),tt();return}}},e&&(e.onclick=()=>je()),t&&(t.onclick=()=>$()),o&&(o.onclick=()=>Ge(-1)),a&&(a.onclick=()=>Ge(1)),Ae(),et(),!0):!1}function et(){const e=ne[i.gameIndex]||ne[0];i.gameMode=e.mode,i.titleEl&&(i.titleEl.textContent=e.title),i.helpEl&&(i.helpEl.textContent=e.help),z&&(z.textContent="Giochi")}function Ge(e){i.gameIndex=(i.gameIndex+e+ne.length)%ne.length,et(),$(),x()}function Ae(){if(!i.canvas)return;const e=Math.min(window.devicePixelRatio||1,2),t=i.canvas.clientWidth,o=i.canvas.clientHeight;if(!t||!o)return;const a=Math.round(t*e),s=Math.round(o*e);(i.canvas.width!==a||i.canvas.height!==s)&&(i.canvas.width=a,i.canvas.height=s)}function $(){re(!1),Ie(),i.score=0,i.timeLeft=30,i.bubbles=[],i.stars=[],i.paddleX=.5,i.scoreEl&&(i.scoreEl.textContent="0"),i.timeEl&&(i.timeEl.textContent="30"),Te()}function je(){i.running||(i.timeLeft<=0&&$(),Ie(),i.running=!0,i.lastTs=performance.now(),i.spawnAcc=0,i.timerId=window.setInterval(()=>{i.running&&(i.timeLeft-=1,i.timeEl&&(i.timeEl.textContent=String(i.timeLeft)),i.timeLeft<=0&&(i.timeLeft=0,i.timeEl&&(i.timeEl.textContent="0"),re(!0)))},1e3),i.rafId=requestAnimationFrame(Ee))}function re(e=!1){i.running=!1,i.timerId&&(clearInterval(i.timerId),i.timerId=null),i.rafId&&(cancelAnimationFrame(i.rafId),i.rafId=null),e&&(Ct(),kt())}function Mt(){if(!i.canvas)return;const e=i.canvas.width,t=i.canvas.height,o=22+Math.random()*26,a=o+Math.random()*(e-o*2),s=o+Math.random()*(t-o*2),r=(-.25+Math.random()*.5)*(window.devicePixelRatio||1),n=(-.15+Math.random()*.35)*(window.devicePixelRatio||1),l=3.2+Math.random()*1.8;i.bubbles.push({x:a,y:s,r:o,vx:r,vy:n,born:performance.now(),life:l})}function Vt(){if(!i.canvas)return;const e=i.canvas.width,t=Math.random()<.22,o=(t?18:16)+Math.random()*12,a=o+Math.random()*(e-o*2),s=-o,n=(110+Math.random()*120+(30-i.timeLeft)*3)*(window.devicePixelRatio||1),l=(-30+Math.random()*60)*(window.devicePixelRatio||1);i.stars.push({x:a,y:s,size:o,vy:n,drift:l,bad:t,rot:Math.random()*Math.PI*2})}function Ee(e){if(!i.running)return;const t=Math.min((e-i.lastTs)/1e3,.05);if(i.lastTs=e,Ae(),i.gameMode==="star"){Pt(t),i.rafId=requestAnimationFrame(Ee);return}const a=.55/(1+(30-i.timeLeft)*.03);for(i.spawnAcc+=t;i.spawnAcc>=a;)i.spawnAcc-=a,Mt();const s=performance.now();for(let r=i.bubbles.length-1;r>=0;r--){const n=i.bubbles[r];n.x+=n.vx*60*t,n.y+=n.vy*60*t,n.x-n.r<0&&(n.x=n.r,n.vx*=-1),n.x+n.r>i.canvas.width&&(n.x=i.canvas.width-n.r,n.vx*=-1),n.y-n.r<0&&(n.y=n.r,n.vy*=-1),n.y+n.r>i.canvas.height&&(n.y=i.canvas.height-n.r,n.vy*=-1),(s-n.born)/1e3>n.life&&i.bubbles.splice(r,1)}Te(),i.rafId=requestAnimationFrame(Ee)}function Pt(e){if(!i.canvas)return;const o=.62/(1+(30-i.timeLeft)*.035);for(i.spawnAcc+=e;i.spawnAcc>=o;)i.spawnAcc-=o,Vt();const a=i.canvas.width,s=i.canvas.height,r=Math.max(92,a*.16),n=Math.max(18,s*.035),l=i.paddleX*a,p=s-n*3.2;for(let m=i.stars.length-1;m>=0;m--){const u=i.stars[m];u.y+=u.vy*e,u.x+=u.drift*e,u.rot+=e*2.4;const A=Math.abs(u.x-l)<=r*.55+u.size*.4,D=Math.abs(u.y-p)<=n*1.2+u.size*.5;if(A&&D){i.stars.splice(m,1),i.score+=u.bad?-2:1,i.score=Math.max(0,i.score),i.scoreEl&&(i.scoreEl.textContent=String(i.score)),u.bad?Ht():tt();continue}u.y-u.size>s&&i.stars.splice(m,1)}Te()}function Te(){if(!i.ctx||!i.canvas)return;const e=i.ctx,t=i.canvas.width,o=i.canvas.height;if(e.clearRect(0,0,t,o),e.fillStyle="rgba(255,255,255,0.22)",e.fillRect(0,0,t,o),i.gameMode==="star"){Rt(e,t,o);return}for(const a of i.bubbles){const s=e.createRadialGradient(a.x-a.r*.35,a.y-a.r*.35,a.r*.2,a.x,a.y,a.r);s.addColorStop(0,"rgba(255,255,255,0.95)"),s.addColorStop(.35,"rgba(255,255,255,0.35)"),s.addColorStop(1,"rgba(43,184,255,0.18)"),e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fillStyle=s,e.fill(),e.lineWidth=2,e.strokeStyle="rgba(43,184,255,0.35)",e.stroke(),e.beginPath(),e.arc(a.x-a.r*.25,a.y-a.r*.25,a.r*.28,0,Math.PI*2),e.fillStyle="rgba(255,255,255,0.28)",e.fill()}}function Rt(e,t,o){const a=e.createLinearGradient(0,0,0,o);a.addColorStop(0,"rgba(218,244,255,0.70)"),a.addColorStop(1,"rgba(255,255,255,0.38)"),e.fillStyle=a,e.fillRect(0,0,t,o);for(const m of i.stars)zt(e,m.x,m.y,m.size,m.rot,m.bad);const s=Math.max(92,t*.16),r=Math.max(18,o*.035),n=i.paddleX*t,l=o-r*3.2;e.save(),e.translate(n,l);const p=e.createLinearGradient(0,-r,0,r);p.addColorStop(0,"rgba(255,255,255,0.94)"),p.addColorStop(1,"rgba(43,184,255,0.30)"),e.fillStyle=p,e.strokeStyle="rgba(43,184,255,0.42)",e.lineWidth=2,Nt(e,-s/2,-r/2,s,r,r/2),e.fill(),e.stroke(),e.restore()}function zt(e,t,o,a,s,r){e.save(),e.translate(t,o),e.rotate(s),e.beginPath();for(let n=0;n<10;n+=1){const l=-Math.PI/2+n*Math.PI/5,p=n%2===0?a:a*.45,m=Math.cos(l)*p,u=Math.sin(l)*p;n===0?e.moveTo(m,u):e.lineTo(m,u)}e.closePath(),e.fillStyle=r?"rgba(255,96,96,0.78)":"rgba(255,218,80,0.86)",e.strokeStyle=r?"rgba(160,30,40,0.35)":"rgba(180,130,20,0.32)",e.lineWidth=2,e.fill(),e.stroke(),e.restore()}function Nt(e,t,o,a,s,r){e.beginPath(),e.moveTo(t+r,o),e.lineTo(t+a-r,o),e.quadraticCurveTo(t+a,o,t+a,o+r),e.lineTo(t+a,o+s-r),e.quadraticCurveTo(t+a,o+s,t+a-r,o+s),e.lineTo(t+r,o+s),e.quadraticCurveTo(t,o+s,t,o+s-r),e.lineTo(t,o+r),e.quadraticCurveTo(t,o,t+r,o),e.closePath()}function tt(){const e=B();if(!e)return;const t=e.currentTime,o=e.createOscillator(),a=e.createGain();o.type="sine",o.frequency.setValueAtTime(620,t),o.frequency.exponentialRampToValueAtTime(280,t+.06),a.gain.setValueAtTime(1e-4,t),a.gain.exponentialRampToValueAtTime(.08,t+.008),a.gain.exponentialRampToValueAtTime(1e-4,t+.1),o.connect(a),a.connect(e.destination),o.start(t),o.stop(t+.12)}function kt(){const e=B();if(!e)return;const t=e.currentTime;[880,740,622].forEach((a,s)=>{const r=e.createOscillator(),n=e.createGain(),l=t+s*.12;r.type="triangle",r.frequency.setValueAtTime(a,l),n.gain.setValueAtTime(1e-4,l),n.gain.exponentialRampToValueAtTime(.06,l+.01),n.gain.exponentialRampToValueAtTime(1e-4,l+.16),r.connect(n),n.connect(e.destination),r.start(l),r.stop(l+.18)})}function Ht(){const e=B();if(!e)return;const t=e.currentTime,o=e.createOscillator(),a=e.createGain();o.type="sawtooth",o.frequency.setValueAtTime(180,t),o.frequency.exponentialRampToValueAtTime(90,t+.1),a.gain.setValueAtTime(1e-4,t),a.gain.exponentialRampToValueAtTime(.035,t+.008),a.gain.exponentialRampToValueAtTime(1e-4,t+.14),o.connect(a),a.connect(e.destination),o.start(t),o.stop(t+.16)}window.addEventListener("resize",()=>{document.getElementById("mgCanvas")&&Ae(),$e(),k()});function pe(){H||(H=!0,N&&(N.classList.add("is-fading"),N.setAttribute("aria-hidden","true"),window.setTimeout(()=>{N.classList.add("is-hidden")},ct),window.setTimeout(()=>{document.body?.classList.remove("is-intro-locked")},lt)),j=Math.max(j,performance.now()+rt),L&&(q(),_(),F()),x(),k())}function Bt(){if(!N){H=!0;return}document.body?.classList.add("is-intro-locked"),N.addEventListener("click",e=>{e.preventDefault(),e.stopPropagation(),pe()}),N.addEventListener("pointerdown",e=>{e.pointerType!=="touch"&&(e.preventDefault(),e.stopPropagation(),pe())}),window.addEventListener("keydown",e=>{H||(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),pe())})}function Se(){const e=window.visualViewport?.height||window.innerHeight;document.documentElement.style.setProperty("--vh",`${e}px`)}mt();M&&M.classList.add("is-swoosh-in");_e();setInterval(_e,1e3);Bt();Se();window.addEventListener("resize",Se);window.visualViewport?.addEventListener("resize",Se);K.addEventListener?(K.addEventListener("change",k),ue.addEventListener("change",k)):(K.addListener(k),ue.addListener(k));
