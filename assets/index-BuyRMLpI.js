(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function n(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(s){if(s.ep)return;s.ep=!0;const a=n(s);fetch(s.href,a)}})();const qe="/Portfolio_Valerio/",d=e=>`${qe}${e.replace(/^\/+/,"")}`,A=document.getElementById("wiiIntro");let S=!1;const T=document.getElementById("grid");document.getElementById("board");const ue=document.getElementById("time"),me=document.getElementById("date"),z=document.getElementById("btnLeft"),k=document.getElementById("btnRight"),v=document.getElementById("wiiOverlay"),ge=document.getElementById("overlayBack"),pe=document.getElementById("overlayTitle"),m=document.getElementById("overlayBody"),y=document.getElementById("wiiPointer"),C=document.getElementById("imgViewer"),G=document.getElementById("imgViewerSrc");function He(e,t,n){return Math.max(t,Math.min(n,e))}const _e=[[{icon:"👋",t:"Chi sono",s:"Bio + competenze",href:"#about",previews:[d("img/BIO/BIO_1.jpg"),d("img/BIO/BIO_2.jpg"),d("img/BIO/BIO_3.jpg")]},{icon:"🎓",t:"Esperienze",s:"Formazione / studi",href:"#exp"},{icon:"✉️",t:"Contatti",s:"Mail e social",href:"#contact"},{icon:"🧩",t:"Progetti",s:"Case study e lavori",href:"#projects",previews:[d("img/PROGETTI/PROG_1.jpg"),d("img/PROGETTI/PROG_2.jpg"),d("img/PROGETTI/PROG_3.jpg")]},{icon:"📱",t:"Social",s:"I miei profili",href:"#social"},{icon:"🎬",t:"Video",s:"Social e progetti",href:"#videos"},{icon:"🛠️",t:"Skills",s:"Cosa so fare",href:"#tools"},{icon:"🤖",t:"AI",s:"Workflow",href:"#ai",previewVideo:{src:d("img/CHANNELS/ai.mp4")}},{icon:"📌",t:"Servizi",s:"Cosa offro",href:"#services",previewVideo:{src:d("img/CHANNELS/servizi.mp4")}}],[{icon:"📷",t:"Galleria",s:"Foto e frame",href:"#gallery"},{icon:"🗂️",t:"Archivio",s:"Lavori passati",href:"#archive"},{icon:"📝",t:"Blog",s:"Note e making-of",href:"#blog"},{icon:"📍",t:"Dove sono",s:"Roma / contatti",href:"#where"}]];let P=0;const $e=420,De=320,Ne=900;function Fe(){return _e[0]}function Ue(){if(!T)return;const e=Fe();T.innerHTML=e.map(t=>{const n=t.previewVideo?.src,o=Array.isArray(t.previews)?t.previews:[],s=n?`
    ...
    `}};function tt(){if(!m)return;const e=oe["#projects"],n=(e.projects[l.projectIndex]||e.projects[0])?.slides||[];if(!n.length)return;l.slideIndex=He(l.slideIndex,0,n.length-1),m.innerHTML=`
