(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function n(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(s){if(s.ep)return;s.ep=!0;const a=n(s);fetch(s.href,a)}})();const Ge="/Portfolio_Valerio/",d=e=>`${Ge}${e.replace(/^\/+/,"")}`,A=document.getElementById("wiiIntro");let L=!1;const C=document.getElementById("grid");document.getElementById("board");const de=document.getElementById("time"),ue=document.getElementById("date"),O=document.getElementById("btnLeft"),V=document.getElementById("btnRight"),v=document.getElementById("wiiOverlay"),me=document.getElementById("overlayBack"),ge=document.getElementById("overlayTitle"),m=document.getElementById("overlayBody"),y=document.getElementById("wiiPointer"),E=document.getElementById("imgViewer"),k=document.getElementById("imgViewerSrc");function je(e,t,n){return Math.max(t,Math.min(n,e))}const qe=[[{icon:"👋",t:"Chi sono",s:"Bio + competenze",href:"#about",previews:[d("img/BIO/BIO_1.jpg"),d("img/BIO/BIO_2.jpg"),d("img/BIO/BIO_3.jpg")]},{icon:"🎓",t:"Esperienze",s:"Formazione / studi",href:"#exp"},{icon:"✉️",t:"Contatti",s:"Mail e social",href:"#contact"},{icon:"🧩",t:"Progetti",s:"Case study e lavori",href:"#projects",previews:[d("img/PROGETTI/PROG_1.jpg"),d("img/PROGETTI/PROG_2.jpg"),d("img/PROGETTI/PROG_3.jpg")]},{icon:"📱",t:"Social",s:"I miei profili",href:"#social"},{icon:"🎬",t:"Video",s:"Reel e underwater",href:"#videos"},{icon:"🛠️",t:"Skills",s:"Cosa so fare",href:"#tools"},{icon:"🤖",t:"AI",s:"Workflow",href:"#ai",previewVideo:{src:d("img/CHANNELS/ai.mp4")}},{icon:"📌",t:"Servizi",s:"Cosa offro",href:"#services",previewVideo:{src:d("img/CHANNELS/servizi.mp4")}}],[{icon:"📷",t:"Galleria",s:"Foto e frame",href:"#gallery"},{icon:"🗂️",t:"Archivio",s:"Lavori passati",href:"#archive"},{icon:"📝",t:"Blog",s:"Note e making-of",href:"#blog"},{icon:"📍",t:"Dove sono",s:"Roma / contatti",href:"#where"}]];function He(){return qe[0]}function $e(){if(!C)return;const e=He();C.innerHTML=e.map(t=>{const n=t.previewVideo?.src,o=Array.isArray(t.previews)?t.previews:[],s=n?`
      ...
      `}).join(""),_e(),De()}function _e(){if(!C)return;Array.from(C.querySelectorAll(".wii-preview:not(.wii-preview--single)")).forEach(t=>{const n=Math.random()*12;t.style.setProperty("--preview-phase",`-${n.toFixed(2)}s`)})}function De(){if(!C)return;Array.from(C.querySelectorAll(".wii-preview--video")).forEach(t=>{const n=t.closest(".wii-tile");if(!n)return;const o=t.querySelector(".preview-video");if(!o)return;o.muted=!0,o.loop=!0,o.setAttribute("playsinline","");const s=()=>{if(o.paused)try{o.currentTime=0}catch{}};o.addEventListener("loadeddata",s,{once:!0});const a=()=>{t.classList.add("is-hover"),o.currentTime=0,o.play().catch(()=>{})},r=()=>{o.pause(),o.currentTime=0,t.classList.remove("is-hover")};n.addEventListener("mouseenter",a),n.addEventListener("mouseleave",r),n.addEventListener("pointerenter",a),n.addEventListener("pointerleave",r),n.addEventListener("focusin",a),n.addEventListener("focusout",r)})}function be(){if(!de||!ue)return;const e=new Date,t=String(e.getHours()).padStart(2,"0"),n=String(e.getMinutes()).padStart(2,"0");de.textContent=`${t}:${n}`;const o=["Dom","Lun","Mar","Mer","Gio","Ven","Sab"],s=["Gen","Feb","Mar","Apr","Mag","Giu","Lug","Ago","Set","Ott","Nov","Dic"],a=e.getDate(),r=o[e.getDay()],c=s[e.getMonth()];ue.textContent=`${r} ${a} ${c}`}let T=null,I=!0,pe=!1,fe=0;function P(){return I?(T||(T=new(window.AudioContext||window.webkitAudioContext)),T.state==="suspended"&&T.resume().catch(()=>{}),T):null}function H(){const e=P();if(e){e.state==="suspended"&&e.resume().catch(()=>{});try{const t=e.createBuffer(1,1,e.sampleRate),n=e.createBufferSource();n.buffer=t,n.connect(e.destination),n.start(0)}catch{}}}function $(){pe||(pe=!0,H())}function Te({type:e="sine",freq:t=700,duration:n=.05,gain:o=.04,attack:s=.002,release:a=.035}={}){const r=P();if(!r)return;const c=r.currentTime,g=r.createOscillator(),f=r.createGain();g.type=e,g.frequency.setValueAtTime(t,c),f.gain.setValueAtTime(0,c),f.gain.linearRampToValueAtTime(o,c+s),f.gain.exponentialRampToValueAtTime(1e-4,c+s+a),g.connect(f),f.connect(r.destination),g.start(c),g.stop(c+n+a+.02)}function Ne(){const e=performance.now();e-fe<120||(fe=e,Te({type:"sine",freq:880,duration:.03,gain:.026,attack:.002,release:.03}))}function R(){Te({type:"triangle",freq:520,duration:.03,gain:.05,attack:.001,release:.02})}let b=null;function _(){const e=P();if(!e||b)return;const t=e.createGain();t.gain.value=0,t.connect(e.destination);const n=e.createDelay(.35);n.delayTime.value=.18;const o=e.createGain();o.gain.value=.2,n.connect(o),o.connect(n);const s=e.createGain();s.gain.value=.25;const a=e.createBiquadFilter();a.type="lowpass",a.frequency.value=2600,a.Q.value=.7,a.connect(t),a.connect(n),n.connect(s),s.connect(t);const r=e.createOscillator();r.type="sine",r.frequency.value=130.81;const c=e.createGain();c.gain.value=1e-4,r.connect(c),c.connect(a);const g=e.createOscillator();g.type="sine",g.frequency.value=.08;const f=e.createGain();f.gain.value=.007,g.connect(f),f.connect(c.gain);const M=e.currentTime;r.start(M),g.start(M);function ae(x,u,S=.05){const p=e.createOscillator(),h=e.createGain(),w=e.createBiquadFilter();p.type="triangle",p.frequency.setValueAtTime(x,u),w.type="highpass",w.frequency.setValueAtTime(240,u),h.gain.setValueAtTime(1e-4,u),h.gain.exponentialRampToValueAtTime(S,u+.01),h.gain.exponentialRampToValueAtTime(1e-4,u+.22),p.connect(w),w.connect(h),h.connect(a),p.start(u),p.stop(u+.3)}function ze(x,u,S=.018){const p=e.createOscillator(),h=e.createGain(),w=e.createBiquadFilter();p.type="sine",p.frequency.setValueAtTime(x,u),w.type="lowpass",w.frequency.setValueAtTime(520,u),h.gain.setValueAtTime(1e-4,u),h.gain.exponentialRampToValueAtTime(S,u+.008),h.gain.exponentialRampToValueAtTime(1e-4,u+.18),p.connect(w),w.connect(h),h.connect(a),p.start(u),p.stop(u+.22)}const F=[{tones:[261.63,329.63,392],bass:130.81},{tones:[349.23,440,523.25],bass:174.61},{tones:[220,261.63,329.63],bass:110},{tones:[196,246.94,293.66],bass:98}],U=[[0,1,2,1,0,2,1,2],[0,2,1,2,0,1,2,1],[0,1,0,2,1,2,1,0]],Be=300,ce=8,Ve=2;let W=0,K=0,X=0,Y=0;function le(){if(!I||!T||!b)return;const x=T.currentTime,u=F[X%F.length],S=U[Y%U.length],p=W%ce,h=S[p]%u.tones.length,w=u.tones[h],ke=p===0?.058:p===4?.05:.04;ae(w,x+.01,ke),p===0&&ze(u.bass,x+.01,.016),Math.random()<.1&&ae(w*2,x+.06,.026),W+=1,W%ce===0&&(K+=1,K%2===0&&(Y=(Y+1)%U.length),K%Ve===0&&(X=(X+1)%F.length)),b.timerId=window.setTimeout(le,Be)}b={musicGain:t,lp:a,delay:n,fb:o,delayMix:s,drone:r,droneGain:c,lfo:g,timerId:null},le(),t.gain.setTargetAtTime(.4,e.currentTime,.7)}function Fe(){if(!T||!b)return;const e=T.currentTime;b.timerId&&clearTimeout(b.timerId),b.musicGain.gain.setTargetAtTime(1e-4,e,.25),setTimeout(()=>{try{b.drone?.stop()}catch{}try{b.lfo?.stop()}catch{}b=null},400)}O&&(O.textContent="🔊",O.addEventListener("click",()=>{I=!I,O.textContent=I?"🔊":"🔇",I?($(),H(),_(),R()):Fe()}));V&&(V.textContent="🎮");["pointerdown","touchstart","mousedown"].forEach(e=>{window.addEventListener(e,()=>{I&&($(),_())},{once:!0,passive:!0})});const l={href:null,projectIndex:0,slideIndex:0,dom:null};let z=null;const ve="https://www.linkedin.com/in/valerio-serani-682a48215/",Ue="https://www.instagram.com/velvet_172/",We="https://www.tiktok.com/@heyits172",Ke="https://vimeo.com/user95787021",Xe="https://www.behance.net/velvet172",he="valerioserani@gmail.com",we="+39 3469697747",ie={"#projects":{title:"Progetti",projects:[{id:"bestof",slides:[{src:d("img/PROGETTI/PROG_1.jpg"),client:"Sunsilk",title:"Testata Home 2025",what:"Creativity + layout",moreHtml:`
    ...
    `}};function Ye(){if(!m)return;const e=ie["#projects"],n=(e.projects[l.projectIndex]||e.projects[0])?.slides||[];if(!n.length)return;l.slideIndex=je(l.slideIndex,0,n.length-1),m.innerHTML=`
...
`;const o={frame:m.querySelector("[data-ch-frame]"),imgs:Array.from(m.querySelectorAll(".chMedia")),more:m.querySelector(".chMore"),moreContent:m.querySelector(".chMoreContent"),capClient:m.querySelector('[data-cap="client"]'),capTitle:m.querySelector('[data-cap="title"]'),capWhat:m.querySelector('[data-cap="what"]')};l.dom=o,ne(n,l.slideIndex);const s=m.querySelector('[data-ch="more"]');s&&(s.textContent="Scopri di più")}function ne(e,t){const n=e[t],o=l.dom;!n||!o||(o.capClient&&(o.capClient.textContent=n.client||""),o.capTitle&&(o.capTitle.textContent=n.title||""),o.capWhat&&(o.capWhat.textContent=n.what||""),o.frame&&o.frame.style.setProperty("--ch-bg",`url("${n.src}")`),o.moreContent&&(o.moreContent.innerHTML=n.moreHtml||""))}function J(){return!!l.dom?.frame?.classList.contains("is-more")}function Je(e){const t=l.dom;!t?.frame||!t?.more||(t.frame.classList.add("is-more"),t.more.classList.add("is-open"),t.more.setAttribute("aria-hidden","false"),ne(e,l.slideIndex))}function B(){const e=l.dom;!e?.frame||!e?.more||(e.frame.classList.remove("is-more"),e.more.classList.remove("is-open"),e.more.setAttribute("aria-hidden","true"))}function Qe(){Ie();const e=m?.querySelector(".bioCarousel"),t=m?.querySelector(".wii-card"),n=e?Array.from(e.querySelectorAll(".bioMedia")):[];if(!e||!n.length)return;t&&t.classList.add("bio-no-blur");let o=0;const s=()=>{n.forEach((r,c)=>r.classList.toggle("is-on",c===o));const a=n[o]?.getAttribute("src");a&&e.style.setProperty("--bio-bg",`url("${a}")`)};s(),z=window.setInterval(()=>{o=(o+1)%n.length,s()},3e3),t&&t.classList.add("bio-no-blur")}function Ie(){z&&(clearInterval(z),z=null)}function Ee(e){if(!v||!ge||!m)return;l.href=e,v.classList.toggle("is-game",e==="#minigame"),v.classList.toggle("is-carousel",e==="#projects"),v.classList.toggle("is-about",e==="#about"),v.classList.toggle("is-exp",e==="#exp");const t=ie[e]||{title:"Canale",html:'<div class="wii-card"><h3>Coming soon</h3><p>Contenuto in arrivo.</p></div>'};ge.textContent=t.title,e==="#projects"&&t.projects?(l.projectIndex=0,l.slideIndex=0,l.dom=null,Ye()):e==="#about"?(m.innerHTML=t.html||"",Qe()):m.innerHTML=t.html||"",v.classList.add("is-open"),v.setAttribute("aria-hidden","false"),e==="#minigame"?requestAnimationFrame(()=>{it()&&q()}):N(!1),R()}function D(){v&&(B(),N(!1),Ie(),v.classList.remove("is-open","is-game","is-carousel"),v.setAttribute("aria-hidden","true"),R())}me&&me.addEventListener("click",D);function Ze(e){!E||!k||!e||(k.src=e,E.classList.add("is-open"),E.setAttribute("aria-hidden","false"))}function Ce(){!E||!k||(E.classList.remove("is-open"),E.setAttribute("aria-hidden","true"),k.src="")}E&&E.addEventListener("click",Ce);v&&v.addEventListener("click",e=>{e.target===v&&D()});document.addEventListener("keydown",e=>{if(e.key==="Escape"&&E?.classList.contains("is-open")){Ce();return}e.key==="Escape"&&v?.classList.contains("is-open")&&D()});document.addEventListener("click",e=>{if(!L)return;const t=e.target?.closest?.(".wii-tile");if(!t)return;const n=t.getAttribute("data-href")||t.getAttribute("href");n&&n.startsWith("#")&&(e.preventDefault(),Ee(n))});V&&V.addEventListener("click",e=>{L&&(e.preventDefault(),Ee("#minigame"))});m?.addEventListener("click",e=>{if(l.href==="#projects"&&e.target?.closest?.("[data-ch-frame]")){const f=l.dom?.imgs?.find(M=>M.classList.contains("is-on"))?.getAttribute("src");if(f){e.preventDefault(),e.stopPropagation(),Ze(f);return}}const t=e.target?.closest?.("[data-ch]"),n=t?.getAttribute("data-ch");if(e.target?.closest?.("[data-ch-frame]")&&J()&&!t){B();const c=m.querySelector('[data-ch="more"]');c&&(c.textContent="Scopri di più");return}if(!n||l.href!=="#projects")return;const s=ie["#projects"],r=(s.projects[l.projectIndex]||s.projects[0])?.slides||[];if(r.length){if(n==="more"){J()?(B(),t.textContent="Scopri di più"):(Je(r),t.textContent="Chiudi");return}if(n==="prev"||n==="next"){if(J()){B();const c=m.querySelector('[data-ch="more"]');c&&(c.textContent="Scopri di più")}n==="prev"?l.slideIndex=(l.slideIndex-1+r.length)%r.length:l.slideIndex=(l.slideIndex+1)%r.length,l.dom?.imgs?.forEach((c,g)=>c.classList.toggle("is-on",g===l.slideIndex)),ne(r,l.slideIndex);return}}});let xe=0,Ae=0,Q=0,Z=0,te=!1,G="mouse",j=null;function et(){y&&(te||(te=!0,y.style.opacity="1"))}function Le(){y&&(te=!1,y.style.opacity="0")}function Se(){Q+=(xe-Q)*.18,Z+=(Ae-Z)*.18;const e=-10,t=-4;y&&(y.style.transform=`translate3d(${Q+e}px, ${Z+t}px, 0)`),requestAnimationFrame(Se)}requestAnimationFrame(Se);window.addEventListener("pointermove",e=>{if(G=e.pointerType||"mouse",G!=="mouse"){Le();return}xe=e.clientX,Ae=e.clientY,et()});window.addEventListener("mouseleave",()=>Le());const Pe=".wii-tile, .wii-pill";function Re(e){y&&y.classList.toggle("is-hover",e)}document.addEventListener("pointerover",e=>{if(G!=="mouse")return;const t=e.target?.closest?.(Pe);t&&t!==j&&(j=t,Re(!0),Ne())});document.addEventListener("pointerout",e=>{const t=e.target?.closest?.(Pe);if(t&&t===j){const n=e.relatedTarget;if(n&&t.contains(n))return;j=null,Re(!1)}});document.addEventListener("pointerdown",()=>{I&&($(),H(),_()),!(!y||G!=="mouse")&&(y.classList.add("is-down"),R())});document.addEventListener("pointerup",()=>{y&&y.classList.remove("is-down")});let i={running:!1,score:0,timeLeft:30,lastTs:0,spawnAcc:0,bubbles:[],rafId:null,timerId:null,canvas:null,ctx:null,scoreEl:null,timeEl:null,overEl:null,overScoreEl:null,overRestartBtn:null,overCloseBtn:null};function oe(){i.overEl&&(i.overEl.classList.remove("is-show"),i.overEl.setAttribute("aria-hidden","true"))}function tt(){i.overEl&&(i.overScoreEl&&(i.overScoreEl.textContent=String(i.score)),i.overEl.classList.add("is-show"),i.overEl.setAttribute("aria-hidden","false"))}function it(){i.canvas=document.getElementById("mgCanvas"),i.scoreEl=document.getElementById("mgScore"),i.timeEl=document.getElementById("mgTime"),i.overEl=document.getElementById("mgOver"),i.overScoreEl=document.getElementById("mgOverScore"),i.overRestartBtn=document.getElementById("mgOverRestart"),i.overCloseBtn=document.getElementById("mgOverClose");const e=document.getElementById("mgStart"),t=document.getElementById("mgReset");return i.canvas?(i.ctx=i.canvas.getContext("2d"),oe(),i.overRestartBtn&&(i.overRestartBtn.onclick=()=>{q(),ye()}),i.overCloseBtn&&(i.overCloseBtn.onclick=()=>D()),i.canvas.onpointerdown=n=>{if(!i.running)return;const o=i.canvas.getBoundingClientRect(),s=(n.clientX-o.left)/o.width*i.canvas.width,a=(n.clientY-o.top)/o.height*i.canvas.height;for(let r=i.bubbles.length-1;r>=0;r--){const c=i.bubbles[r],g=s-c.x,f=a-c.y;if(g*g+f*f<=c.r*c.r){i.bubbles.splice(r,1),i.score+=1,i.scoreEl&&(i.scoreEl.textContent=String(i.score)),ot();return}}},e&&(e.onclick=()=>ye()),t&&(t.onclick=()=>q()),re(),!0):!1}function re(){if(!i.canvas)return;const e=Math.min(window.devicePixelRatio||1,2),t=i.canvas.clientWidth,n=i.canvas.clientHeight;if(!t||!n)return;const o=Math.round(t*e),s=Math.round(n*e);(i.canvas.width!==o||i.canvas.height!==s)&&(i.canvas.width=o,i.canvas.height=s)}function q(){N(!1),oe(),i.score=0,i.timeLeft=30,i.bubbles=[],i.scoreEl&&(i.scoreEl.textContent="0"),i.timeEl&&(i.timeEl.textContent="30"),Oe()}function ye(){i.running||(i.timeLeft<=0&&q(),oe(),i.running=!0,i.lastTs=performance.now(),i.spawnAcc=0,i.timerId=window.setInterval(()=>{i.running&&(i.timeLeft-=1,i.timeEl&&(i.timeEl.textContent=String(i.timeLeft)),i.timeLeft<=0&&(i.timeLeft=0,i.timeEl&&(i.timeEl.textContent="0"),N(!0)))},1e3),i.rafId=requestAnimationFrame(Me))}function N(e=!1){i.running=!1,i.timerId&&(clearInterval(i.timerId),i.timerId=null),i.rafId&&(cancelAnimationFrame(i.rafId),i.rafId=null),e&&(tt(),rt())}function nt(){if(!i.canvas)return;const e=i.canvas.width,t=i.canvas.height,n=22+Math.random()*26,o=n+Math.random()*(e-n*2),s=n+Math.random()*(t-n*2),a=(-.25+Math.random()*.5)*(window.devicePixelRatio||1),r=(-.15+Math.random()*.35)*(window.devicePixelRatio||1),c=3.2+Math.random()*1.8;i.bubbles.push({x:o,y:s,r:n,vx:a,vy:r,born:performance.now(),life:c})}function Me(e){if(!i.running)return;const t=Math.min((e-i.lastTs)/1e3,.05);i.lastTs=e,re();const o=.55/(1+(30-i.timeLeft)*.03);for(i.spawnAcc+=t;i.spawnAcc>=o;)i.spawnAcc-=o,nt();const s=performance.now();for(let a=i.bubbles.length-1;a>=0;a--){const r=i.bubbles[a];r.x+=r.vx*60*t,r.y+=r.vy*60*t,r.x-r.r<0&&(r.x=r.r,r.vx*=-1),r.x+r.r>i.canvas.width&&(r.x=i.canvas.width-r.r,r.vx*=-1),r.y-r.r<0&&(r.y=r.r,r.vy*=-1),r.y+r.r>i.canvas.height&&(r.y=i.canvas.height-r.r,r.vy*=-1),(s-r.born)/1e3>r.life&&i.bubbles.splice(a,1)}Oe(),i.rafId=requestAnimationFrame(Me)}function Oe(){if(!i.ctx||!i.canvas)return;const e=i.ctx,t=i.canvas.width,n=i.canvas.height;e.clearRect(0,0,t,n),e.fillStyle="rgba(255,255,255,0.22)",e.fillRect(0,0,t,n);for(const o of i.bubbles){const s=e.createRadialGradient(o.x-o.r*.35,o.y-o.r*.35,o.r*.2,o.x,o.y,o.r);s.addColorStop(0,"rgba(255,255,255,0.95)"),s.addColorStop(.35,"rgba(255,255,255,0.35)"),s.addColorStop(1,"rgba(43,184,255,0.18)"),e.beginPath(),e.arc(o.x,o.y,o.r,0,Math.PI*2),e.fillStyle=s,e.fill(),e.lineWidth=2,e.strokeStyle="rgba(43,184,255,0.35)",e.stroke(),e.beginPath(),e.arc(o.x-o.r*.25,o.y-o.r*.25,o.r*.28,0,Math.PI*2),e.fillStyle="rgba(255,255,255,0.28)",e.fill()}}function ot(){const e=P();if(!e)return;const t=e.currentTime,n=e.createOscillator(),o=e.createGain();n.type="sine",n.frequency.setValueAtTime(620,t),n.frequency.exponentialRampToValueAtTime(280,t+.06),o.gain.setValueAtTime(1e-4,t),o.gain.exponentialRampToValueAtTime(.08,t+.008),o.gain.exponentialRampToValueAtTime(1e-4,t+.1),n.connect(o),o.connect(e.destination),n.start(t),n.stop(t+.12)}function rt(){const e=P();if(!e)return;const t=e.currentTime;[880,740,622].forEach((o,s)=>{const a=e.createOscillator(),r=e.createGain(),c=t+s*.12;a.type="triangle",a.frequency.setValueAtTime(o,c),r.gain.setValueAtTime(1e-4,c),r.gain.exponentialRampToValueAtTime(.06,c+.01),r.gain.exponentialRampToValueAtTime(1e-4,c+.16),a.connect(r),r.connect(e.destination),a.start(c),a.stop(c+.18)})}window.addEventListener("resize",()=>{document.getElementById("mgCanvas")&&re()});function ee(){L||(L=!0,A&&(A.classList.add("is-hidden"),A.setAttribute("aria-hidden","true")),I&&($(),H(),_()),R())}function st(){if(!A){L=!0;return}A.addEventListener("click",e=>{e.preventDefault(),ee()}),A.addEventListener("pointerdown",e=>{e.preventDefault(),ee()}),window.addEventListener("keydown",e=>{L||(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),ee())})}function se(){const e=window.visualViewport?.height||window.innerHeight;document.documentElement.style.setProperty("--vh",`${e}px`)}$e();C&&C.classList.add("is-swoosh-in");be();setInterval(be,1e3);st();se();window.addEventListener("resize",se);window.visualViewport?.addEventListener("resize",se);
